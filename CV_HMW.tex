...
% personal data
\name{Mengwen}{He}
\title{Research Student/Assistant}                               % optional, remove / comment the line if not wanted
\address{609 National Innovation Complex (NIC) Building}{Nagoya University, Furo-cho, Chikusa-ku}{Nagoya 464-8601, Japan}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\email{alexanderhmw@gmail.com}                               % optional, remove / comment the line if not wanted
...
\cvitem{2014--Present}{{Vehicle details detection and tracking using integrated data for safe prediction.}\newline}
...
\cventry{2014.10--Present}{Research Student}{Graduate School of Information Science, Nagoya University}{Japan}{}{Supervisor: Assoc. Prof. Shinpei Kato\newline}
\cventry{2014.10--Present}{Research Assistant}{Institute of Innovation for Future Society, Nagoya University}{Japan}{}{Supervisor: Prof. Yoshiki Ninomiya\newline}
